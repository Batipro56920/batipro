...
const USEFUL_DOCUMENT_WORDS = ["notice", "procedure", "procédure", "technique", "fiche", "pose", "materiau", "materiaux", "sécurité", "securite"];
