...
export default function Sidebar({ collapsed = false, onToggleCollapse, companyName }: Props) {
  ...
  const nav = [
    ...
    { to: "/financier/decaissements", label: "Décaissements", icon: Wallet, feature: "approvisionnement" as const, permissionKey: "fournisseurs" as const, group: "Financier" },
    { to: "/financier/tva", label: "TVA", icon: Landmark, feature: "rapports" as const, permissionKey: "statistiques" as const, group: "Financier" },
    { to: "/financier/tresorerie", label: "Trésorerie", icon: TrendingUp, feature: "rapports" as const, permissionKey: "statistiques" as const, group: "Financier" },
  ...
  return (
    <div className="flex h-full flex-col bg-sidebar text-sidebar-contrast">
      <div className={["shrink-0 border-b border-sidebar-contrast/10", collapsed ? "p-3" : "p-4"].join(" ")}>
