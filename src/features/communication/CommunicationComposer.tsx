...
import { CalendarClock, Check, CheckCircle2, ChevronRight, Copy, Eye, Link2, Paperclip, Send, Sparkles } from "lucide-react";
...
export function CommunicationComposer({ campaigns, chantiers, onSaved }: Props) {
  ...
  return <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_390px]">
    <section className="space-y-5 rounded-2xl border border-subtle bg-surface p-5 shadow-sm">
      ...
      <CreativeStudioLinks hint="Exporte puis ajoute plusieurs fichiers ci-dessous. La synchronisation Canva automatique arrive avec OAuth." />
