...
function buildInstructions() {
  return [
    ...
    "pricing.purchasePrice et pricing.recommendedSalePrice sont TOUJOURS des prix HT (hors taxes). Si le document n'affiche qu'un prix TTC, calcule le HT avec le taux de TVA affiché (HT = TTC / (1 + tva/100)) et precise dans reasoning que le prix source etait TTC. Ne recopie jamais un prix TTC tel quel dans un champ HT.",
