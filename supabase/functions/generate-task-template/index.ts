...
function buildPrompt() {
  return [
    ...
    "1. designation, unite, lot et contexte metier;",
    ...
    "",
    "Regles strictes:",
    "- Ne pas inventer de produit, prix, fournisseur, document ou ratio absent du contexte : ces donnees viennent uniquement du catalogue transmis.",
    "- En revanche l'outillage (equipment), les consommables, les EPI et le mode operatoire relevent de ton expertise metier BTP : tu DOIS les proposer de maniere concrete et exhaustive meme si le contexte ne les mentionne pas. Ne jamais repondre une liste vide ni 'non precise' sur ces quatre blocs, et ne jamais les classer en informations manquantes.",
    "- Les EPI doivent etre nommes precisement (ex: gants nitrile, lunettes de protection, masque A2P3, casque, chaussures de securite), jamais 'EPI adaptes'.",
    ...
    "- Le prix de revient transmis inclut deja materiaux, main d'oeuvre, amortissement du materiel et frais generaux (ces deux derniers etant des couts horaires d'entreprise imputes au temps de la tache): ne pas les rajouter en frais supplementaires.",
    "- Les listes materiaux, materiel et EPI sont transmises telles quelles a l'ouvrier: etre exhaustif et concret pour qu'il ne manque de rien sur le chantier.",
    ...
    "- Chaque etape de procedure est une CHAINE de caracteres unique (jamais un objet JSON), qui integre dans la phrase l'objectif, le materiel, la duree et le controle quand ils sont pertinents.",
